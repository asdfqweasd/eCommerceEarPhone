    ...
    <MainContainer>
      <MainWrapper>
        <MainSpeakerWrapper>
          ...
          <MainSpeakerInfo>
            ...
            <GlobalBtnBlack
              ...
              aria-label="link to ZX9 speaker product detail page"
              to="/product_detail/zx9"
            />
          </MainSpeakerInfo>
        </MainSpeakerWrapper>
        ...
        >
          ...
          <GlobalBtnWhite
            data-text="see product"
            aria-label="link to ZX7 speaker product detail page"
            to="/product_detail/zx7"
          />
        </MainSpeakerSecWrapper>
        ...
        <MainEarphoneWrapper>
          <MainEarphoneImg
            ...
            data-aos-delay="100"
            src={earphoneYX1Img}
            alt="earphone YX1 product image"
          />
          <MainEarphoneInfo>
            <MainH3>YX1 EARPHONES</MainH3>
            <GlobalBtnWhite
              data-text="see product"
              aria-label="link to YX1 earphone product detail page"
              to="/product_detail/yx1"
            />
          </MainEarphoneInfo>
        </MainEarphoneWrapper>
      </MainWrapper>
